            ...
            modelBuilder.Entity("MemeGenerator.Models.Meme", b =>
                {
                    ...
                    b.HasData(
                        new { MemeId = 1, bottomText = "Peace", bottomTextX = 0, bottomTextY = 0, fontSize = 38, imagePath = "/Images/Batman.jpg", topText = "Howdy", topTextX = 0, topTextY = 0 },
                        new { MemeId = 2, bottomText = "Ciao", bottomTextX = 0, bottomTextY = 0, fontSize = 38, imagePath = "/Images/Spiderman.jpg", topText = "Hola", topTextX = 0, topTextY = 0 }
                    );
                });
